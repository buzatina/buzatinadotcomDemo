...
router.post('/askQuestion', function(req, res){
	...
	var newQuestion = new Question({userid: req.user._id, question: question, latitude: req.user.latitude, longitude: req.user.longitude, name: req.user.name, email: req.user.email, username: req.user.username, picQuestion: req.user.picUrl, location: {coordinates: locationArray}});
